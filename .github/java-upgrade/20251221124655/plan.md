...
## Project Information
- **Project path**: c:\Users\user\Documents\ShareEx\product\ShareEX\demo
- **Working branch**: appmod/java-upgrade-20251221124655
...
- **Build tool path**: c:\Users\user\Documents\ShareEx\product\ShareEX\demo
...
1. Set up the development environment using tool #setup_upgrade_environment.
    ...
    - Create working branch `appmod/java-upgrade-20251221124655`.
